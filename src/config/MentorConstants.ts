export const MENTOR_LINES = [
  ...
  'We are all vampires, after all.\n\nSo human blood is the classic!',
  "Some customers are old-school!\n\nSo just give them standard human blood if they ask for something 'no-frills', 'classic', or 'standard'.",
  "Other vampires are a bit more eccentric.\n\nFor example, I like fish blood!\n\nYeah it's a bit weird, but I love the fishy taste.",
  ...
  'But sometimes, I do like a tiny bit of reptilian blood for an added kick.\n\nKind of like really spicy food!',
  ...
  'Listen closely to keywords the customers say.\n\nAnd I hope you studied your fractions!',
  'If I want something a "little" X, just give me two pours.(A quarter of a glass)\n\nIf I want something "fairly" X, give me four pours (half).\n\nAnd if I want something "mostly" X, give me 6 pours (3 quarters).',
  "I've put useful keywords to look out for in that handy dandy guidebook on the right!",
  'It should tell you how much to pour for given keywords like "mostly", "very", "fairly", etc.',
